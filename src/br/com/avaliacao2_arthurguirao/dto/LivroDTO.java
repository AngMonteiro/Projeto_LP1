...
public class LivroDTO {
    ...
    private Double p_custo_livro, p_emprestimo_livro;
    ...
    public Double getP_emprestimo_livro() {
        return p_emprestimo_livro;
    }

    public void setP_emprestimo_livro(Double p_emprestimo_livro) {
        this.p_emprestimo_livro = p_emprestimo_livro;
    }
